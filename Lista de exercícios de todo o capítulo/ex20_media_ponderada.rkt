...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex20_media_ponderada) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "convert.rkt" "teachpack" "htdp") (lib "guess.rkt" "teachpack" "htdp") (lib "master.rkt" "teachpack" "htdp") (lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "convert.rkt" "teachpack" "htdp") (lib "guess.rkt" "teachpack" "htdp") (lib "master.rkt" "teachpack" "htdp") (lib "draw.rkt" "teachpack" "htdp")) #f)))
;; calcula-media numero numero numero numero -> numero
;; dadas as 4 notas de um aluno, calcula sua media ponderada, com a primeira nota
;; tendo peso  4 e as demais notas peso 2
;; Exemplos:
;; (calcula-media 4 4 4 4) = 4
;; (calcula-media 6 6 8 8) = 
(define (calcula-media n1 n2 n3 n4)
  (/ ( +
       (* 4 n1) (* 2 n2) (* 2 n3) (* 2 n4)) 10))
;; Testes:
(check-expect (calcula-media 4 4 4 4) 4)
(check-expect (calcula-media 6 6 8 8) 6.8)
