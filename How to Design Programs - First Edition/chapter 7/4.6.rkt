...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |4.6|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "convert.rkt" "teachpack" "htdp") (lib "guess.rkt" "teachpack" "htdp") (lib "master.rkt" "teachpack" "htdp") (lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "convert.rkt" "teachpack" "htdp") (lib "guess.rkt" "teachpack" "htdp") (lib "master.rkt" "teachpack" "htdp") (lib "draw.rkt" "teachpack" "htdp")) #f)))
;; a shape is either:
;;   - (make-circle C P N)
...
(define my-shape (make-circle 'red (make-posn 30 30) 20))
(start 100 100)
(move-shape
 (move-shape
  (move-shape (move-shape my-shape 10) 10)
  10)
 10)
"should be"
(make-circle 'red (make-posn 70 30) 20)