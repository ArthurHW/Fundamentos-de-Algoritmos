...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise.3.3.4) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "convert.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "convert.rkt" "teachpack" "htdp")) #f)))
...
;; EXAMPLES AS TESTS
;; (check-expect (area-circle 3) (* 9 pi))
;; (check-expect(circumference 3) (* 6 pi))
;; (check-expect (area-donut 3 5) (* 16 pi))
;; (check-expect (area-pipe 2 3 4) (* 112 pi))
;; (check-expect (area-pipe-one-def 2 3 4) (* 112 pi))